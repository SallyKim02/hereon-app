...
export default function GPage6_Taste({ onPrev, onContinue }: { onPrev?: () => void; onContinue: () => void }) {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      <ScrollView contentContainerStyle={styles.screen} keyboardShouldPersistTaps="handled">
        <Text style={styles.h1}>미각에 집중해보세요</Text>
        <Text style={styles.desc}>어떤 맛을 느낄 수 있나요?</Text>
        <Text style={styles.example}>예: 달달한, 시큼한, 물, 텁텁한…</Text>

        <Text style={styles.progress}>남은 항목 0 / 1</Text>
